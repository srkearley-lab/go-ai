  ...
  gr: {
    ...
    contact: {
      ...
      faqs: [
        ...
        { q: 'Τι γίνεται αν θέλω αλλαγές αφού η ιστοσελίδα ανεβεί Διαδικτυακά;', a: 'Οι πελάτες Growth και Premium λαμβάνουν απεριόριστες ενημερώσεις μέσω WhatsApp — συνήθως την ίδια μέρα.' },
