  ...
  gr: {
    ...
    journeyData: {
      ...
      bundles: {
        ...
        'bundle-social-growth':    { name: 'Ιστοσελίδα και Ανάπτυξη Κοινωνικών Μέσων', badge: 'Ανάπτυξη', bestFor: 'Επιχειρήσεις που χτίζουν online παρουσία', features: ['Επαγγελματική κατασκευή', 'Managed φιλοξενία', '12 social posts/μήνα', 'Captions, hashtags, προγραμματισμός'] },
