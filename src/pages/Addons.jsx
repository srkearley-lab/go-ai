...
const groups = [
  {
    ...
    addons: [
      ...
      {
        id: 'addon-whatsapp-chatbot',
        name: 'WhatsApp Chatbot / Basic Setup',
        price: '€150',
        priceNote: 'one-off',
        bestFor: 'Businesses wanting a simple WhatsApp auto-reply and lead setup',
        includes: [
          'Basic WhatsApp auto-reply setup',
          'Enquiry collection flow',
          'Lead notification to your phone',
        ],
        note: 'For full WhatsApp automation, workflows and integrations, see the WhatsApp Automation service.',
        cta: 'basket',
      },
    ],
  },
    ...
    addons: [
      {
        ...
        price: '€20',
        priceNote: '/month',
        bestFor: 'Businesses wanting basic hosting and technical monitoring',
        includes: [
          'Website hosting',
          'Basic website storage',
          'SSL/security basics',
          'Basic uptime monitoring',
          'Monthly platform/plugin checks',
        ],
        note: 'For light website edits, backups and full monthly care, see our Website Care and Maintenance bundle.',
        cta: 'basket',
      },
      {
        ...
        includes: [
          'Extra managed storage above standard allowance',
          'Image and PDF support',
          'Storage monitoring',
        ],
        note: 'Only needed if you exceed the storage included in your Hosting Care plan.',
        cta: 'basket',
      },
      {
      ...
      },
      {
        ...
        price: '€75',
        priceNote: 'one-off',
        bestFor: 'Businesses wanting a one-off SEO setup on their website',
        includes: [
        ...
        note: 'For ongoing monthly SEO management, see the SEO service.',
        cta: 'basket',
      },
      {
